...
VL_INLINE_OPT void VCPU___024root___nba_sequent__TOP__1(VCPU___024root* vlSelf) {
    ...
    // Init
    CData/*2:0*/ CPU__DOT__execute_stage__DOT__ALU0__DOT__funt;
    CPU__DOT__execute_stage__DOT__ALU0__DOT__funt = 0;
    IData/*31:0*/ CPU__DOT__execute_stage__DOT__ALU0__DOT__comb_result;
    CPU__DOT__execute_stage__DOT__ALU0__DOT__comb_result = 0;
    CData/*0:0*/ __Vdly__CPU__DOT__execute_stage__DOT__mul_done;
    __Vdly__CPU__DOT__execute_stage__DOT__mul_done = 0;
    CData/*1:0*/ __Vdly__CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count;
    __Vdly__CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count = 0;
    ...
    __Vdly__CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count 
        = vlSelf->CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count;
    __Vdly__CPU__DOT__execute_stage__DOT__mul_done 
        = vlSelf->CPU__DOT__execute_stage__DOT__mul_done;
    vlSelf->__Vdly__CPU__DOT__WAIT = vlSelf->CPU__DOT__WAIT;
    vlSelf->CPU__DOT__wb_RegWrite = ((IData)(vlSelf->rst) 
                                     && ((1U & (~ (IData)(vlSelf->CPU__DOT__WAIT))) 
    ...
    if (vlSelf->rst) {
        ...
        __Vdly__CPU__DOT__execute_stage__DOT__mul_done = 0U;
        if ((((IData)(((4U == (6U & (IData)(vlSelf->CPU__DOT__id_EX))) 
                       & (0x18U == (0x3fU & vlSelf->CPU__DOT__id_SignExt)))) 
              & (~ (IData)(vlSelf->CPU__DOT__WAIT))) 
             & (~ (IData)(vlSelf->CPU__DOT__execute_stage__DOT__mul_done)))) {
            vlSelf->CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_result 
                = (vlSelf->CPU__DOT__id_Read_Data_1 
                   * vlSelf->CPU__DOT__execute_stage__DOT__ALUSrc_Mux);
            vlSelf->__Vdly__CPU__DOT__WAIT = 1U;
            __Vdly__CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count = 1U;
        } else if (((IData)(vlSelf->CPU__DOT__WAIT) 
                    & (1U == (IData)(vlSelf->CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count)))) {
            __Vdly__CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count = 2U;
        } else if (((IData)(vlSelf->CPU__DOT__WAIT) 
                    & (2U == (IData)(vlSelf->CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count)))) {
            __Vdly__CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count = 3U;
        } else if (((IData)(vlSelf->CPU__DOT__WAIT) 
                    & (3U == (IData)(vlSelf->CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count)))) {
            vlSelf->__Vdly__CPU__DOT__WAIT = 0U;
            __Vdly__CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count = 0U;
            __Vdly__CPU__DOT__execute_stage__DOT__mul_done = 1U;
        }
        if (vlSelf->CPU__DOT__execute_stage__DOT__mul_done) {
            vlSelf->CPU__DOT__ex_PC_from_ExMem = vlSelf->CPU__DOT__execute_stage__DOT__Branch_Address;
            vlSelf->CPU__DOT__ex_Write_Data = vlSelf->CPU__DOT__id_Read_Data_2;
        } else if ((1U & (~ (IData)(vlSelf->CPU__DOT__WAIT)))) {
            vlSelf->CPU__DOT__ex_PC_from_ExMem = vlSelf->CPU__DOT__execute_stage__DOT__Branch_Address;
            vlSelf->CPU__DOT__ex_Write_Data = vlSelf->CPU__DOT__id_Read_Data_2;
        }
        if ((1U & (~ (IData)(vlSelf->CPU__DOT__WAIT)))) {
            vlSelf->CPU__DOT__memory_writeback_stage__DOT__zero_reg 
                = (0U == vlSelf->CPU__DOT__execute_stage__DOT__ALU_O);
        ...
        if (vlSelf->CPU__DOT__execute_stage__DOT__mul_done) {
            vlSelf->CPU__DOT__ex_WriteReg = vlSelf->CPU__DOT__execute_stage__DOT__RegDst_Mux;
        } else if ((1U & (~ (IData)(vlSelf->CPU__DOT__WAIT)))) {
            vlSelf->CPU__DOT__ex_WriteReg = vlSelf->CPU__DOT__execute_stage__DOT__RegDst_Mux;
        }
        if ((1U & (~ (IData)(vlSelf->CPU__DOT__WAIT)))) {
        ...
        vlSelf->CPU__DOT__memory_writeback_stage__DOT__DM_Read_Data 
            = ((4U & (IData)(vlSelf->CPU__DOT__ex_MM))
               ...
               [(0x1fU & (vlSelf->CPU__DOT__ex_ALU_Data 
                          >> 2U))] : 0U);
        if (vlSelf->CPU__DOT__execute_stage__DOT__mul_done) {
            vlSelf->CPU__DOT__ex_ALU_Data = vlSelf->CPU__DOT__execute_stage__DOT__ALU_O;
        ...
        vlSelf->__Vdly__CPU__DOT__WAIT = 0U;
        __Vdly__CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count = 0U;
        vlSelf->CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_result = 0U;
    ...
    vlSelf->CPU__DOT__execute_stage__DOT__Branch_Address 
        = (vlSelf->CPU__DOT__id_NPC + vlSelf->CPU__DOT__id_SignExt);
    ...
    vlSelf->dbg_rd = (0x1fU & (vlSelf->CPU__DOT__fetch_Instruction 
                               >> 0xbU));
    CPU__DOT__execute_stage__DOT__ALU0__DOT__funt = 
        ((0U == (3U & ((IData)(vlSelf->CPU__DOT__id_EX) 
                       >> 1U))) ? 2U : ((1U == (3U 
                                                & ((IData)(vlSelf->CPU__DOT__id_EX) 
                                                   >> 1U)))
                                         ? 6U : ((2U 
                                                  == 
                                                  (3U 
                                                 ...
                                                 ((0x20U 
                                                  ...
                                                  ((0x10U 
                                                   ...
                                                   ((8U 
                                                    ...
                                                    : 2U))
                                                  : 2U)));
    CPU__DOT__execute_stage__DOT__ALU0__DOT__comb_result 
        = ((4U & (IData)(CPU__DOT__execute_stage__DOT__ALU0__DOT__funt))
            ? ((2U & (IData)(CPU__DOT__execute_stage__DOT__ALU0__DOT__funt))
                ? ((1U & (IData)(CPU__DOT__execute_stage__DOT__ALU0__DOT__funt))
                    ? ((vlSelf->CPU__DOT__id_Read_Data_1 
                        < vlSelf->CPU__DOT__execute_stage__DOT__ALUSrc_Mux)
                        ? 1U : 0U) : (vlSelf->CPU__DOT__id_Read_Data_1 
                                      - vlSelf->CPU__DOT__execute_stage__DOT__ALUSrc_Mux))
                : 0U) : ((2U & (IData)(CPU__DOT__execute_stage__DOT__ALU0__DOT__funt))
                          ? ((1U & (IData)(CPU__DOT__execute_stage__DOT__ALU0__DOT__funt))
                              ? (vlSelf->CPU__DOT__id_Read_Data_1 
                                 * vlSelf->CPU__DOT__execute_stage__DOT__ALUSrc_Mux)
                              : (vlSelf->CPU__DOT__id_Read_Data_1 
    ...
    vlSelf->CPU__DOT__execute_stage__DOT__RegDst_Mux 
        = ((1U & (IData)(vlSelf->CPU__DOT__id_EX)) ? (IData)(vlSelf->CPU__DOT__id_Instr_1511)
    ...
    vlSelf->CPU__DOT__execute_stage__DOT__ALU_O = ((IData)(vlSelf->CPU__DOT__execute_stage__DOT__mul_done)
                                                    ? vlSelf->CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_result
                                                    : CPU__DOT__execute_stage__DOT__ALU0__DOT__comb_result);

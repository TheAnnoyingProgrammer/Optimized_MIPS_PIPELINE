...
VL_ATTR_COLD void VCPU___024root___ctor_var_reset(VCPU___024root* vlSelf) {
    ...
    vlSelf->CPU__DOT__WAIT = VL_RAND_RESET_I(1);
    ...
    vlSelf->CPU__DOT__execute_stage__DOT__RegDst_Mux = VL_RAND_RESET_I(5);
    vlSelf->CPU__DOT__execute_stage__DOT__ALUSrc_Mux = VL_RAND_RESET_I(32);
    vlSelf->CPU__DOT__execute_stage__DOT__ALU_O = VL_RAND_RESET_I(32);
    vlSelf->CPU__DOT__execute_stage__DOT__Branch_Address = VL_RAND_RESET_I(32);
    vlSelf->CPU__DOT__execute_stage__DOT__mul_done = VL_RAND_RESET_I(1);
    vlSelf->CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count = VL_RAND_RESET_I(2);
    vlSelf->CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_result = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vdly__CPU__DOT__WAIT = VL_RAND_RESET_I(1);

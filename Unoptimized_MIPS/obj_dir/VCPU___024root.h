...
class alignas(VL_CACHE_LINE_BYTES) VCPU___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*4:0*/ CPU__DOT__execute_stage__DOT__RegDst_Mux;
        CData/*0:0*/ CPU__DOT__execute_stage__DOT__mul_done;
        CData/*1:0*/ CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_count;
        CData/*0:0*/ CPU__DOT__memory_writeback_stage__DOT__zero_reg;
        CData/*0:0*/ CPU__DOT__memory_writeback_stage__DOT__branch_reg;
        CData/*0:0*/ __Vdly__CPU__DOT__WAIT;
        ...
        IData/*31:0*/ CPU__DOT__execute_stage__DOT__ALU_O;
        IData/*31:0*/ CPU__DOT__execute_stage__DOT__Branch_Address;
        IData/*31:0*/ CPU__DOT__execute_stage__DOT__ALU0__DOT__mul_result;

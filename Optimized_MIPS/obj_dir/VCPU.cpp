...
VCPU::VCPU(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , dbg_ALU1_WAIT{vlSymsp->TOP.dbg_ALU1_WAIT}
    , dbg_ALU2_WAIT{vlSymsp->TOP.dbg_ALU2_WAIT}
    ...
    , dbg_ALU1_Out{vlSymsp->TOP.dbg_ALU1_Out}
    , dbg_ALU2_Out{vlSymsp->TOP.dbg_ALU2_Out}

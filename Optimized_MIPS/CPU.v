...
module CPU(
    ...
    output [31:0] dbg_ALU1_Out,      // NEW: raw ALU1 output
    output [31:0] dbg_ALU2_Out,      // NEW: raw ALU2 output
    output        dbg_ALU1_WAIT,     // NEW: ALU1 busy flag
    output        dbg_ALU2_WAIT,     // NEW: ALU2 busy flag
    ...
    wire [31:0] ex_ALU1_Out;
    wire [31:0] ex_ALU2_Out;
    wire        ex_ALU1_WAIT;
    wire        ex_ALU2_WAIT;
    ...
    Execute execute_stage (
        ...
        .dbg_ALU1_Out (ex_ALU1_Out),    // NEW
        .dbg_ALU2_Out (ex_ALU2_Out),    // NEW
        .dbg_ALU1_WAIT(ex_ALU1_WAIT),   // NEW
        .dbg_ALU2_WAIT(ex_ALU2_WAIT),   // NEW
        .clk          (clk),
        .rst          (rst)
    );
    ...
    assign dbg_ALU1_Out      = ex_ALU1_Out;      // NEW
    assign dbg_ALU2_Out      = ex_ALU2_Out;      // NEW
    assign dbg_ALU1_WAIT     = ex_ALU1_WAIT;     // NEW
    assign dbg_ALU2_WAIT     = ex_ALU2_WAIT;     // NEW
